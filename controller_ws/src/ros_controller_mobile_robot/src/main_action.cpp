...
class Controller {
    ...
    void define_sub_pub(ros::NodeHandle* n)
    {
        ...
        path_theta_sub =            n->subscribe(path_theta_topic,10 , &Controller::path_theta_back, this);  //path_back2
        path_mpc_sub   =            n->subscribe(path_mpc_topic,10 , &Controller::path_mpc_back, this);  //path_mpc
    //  direction_sub       = n.subscribe("/detection_passage_server/result",10 , simulate_rotation_back);
        ...
        odom_sub =                  n->subscribe("/husky_velocity_controller/odom", 5, &Controller::odom_back, this);
        ...
        detection_passage_pub =     n->advertise<control_mobile_robot::SimulatecollisionActionGoal>("/detection_passage_server/goal", 1, this);
