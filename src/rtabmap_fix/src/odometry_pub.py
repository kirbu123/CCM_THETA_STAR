...
def talker():
    ...
    while not rospy.is_shutdown():
        try:
            (trans_local, rot_local) = listener.lookupTransform('/local_map_lidar', '/base_link', rospy.Time(0))
            (trans_global, rot_global) = (trans_local, rot_local)
            ...
            odometry_local_msg.header.frame_id = 'local_map_lidar'
