...
if("TRUE" STREQUAL "TRUE")
  set(mpc_planner_SOURCE_PREFIX /home/vitaly/theta_star_ws/src/MPC_Local_Planner)
  set(mpc_planner_DEVEL_PREFIX /home/vitaly/theta_star_ws/devel)
  ...
  set(mpc_planner_INSTALL_PREFIX /home/vitaly/theta_star_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vitaly/theta_star_ws/src/MPC_Local_Planner/${idir}'.  ${_report}")
    endif()
